...
const PAGE_COPY = {
  zh: {
    ...
    guideTitle: "评测指引",
    guideCopy1: "歌声技巧可以改变歌手演唱时的声音效果，包括气声、混声、咽音、假声等音色技巧，以及滑音、颤音等音高技巧。不同技巧的参考音频会在后续给出。该测评旨在评价不同模型生成技巧音频的质量，测评结果将作为相关科学研究的一部分。",
    guideCopy2: "本次测评包含三组单一技巧转换评测和三条复合技巧转换评测。一条源音频对应两至三条生成音频，请对生成音频的各项指标打分。技巧参考会在对应评测前给出，评价指标介绍在下方给出；请先试听参考，再评价匿名候选结果。请先填写个人信息，再参与评分。完成全部评分后，请点击“上传评分”按钮。",
